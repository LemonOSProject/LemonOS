...
buildp(){
	...
	cmake -G Ninja .. -DCMAKE_CROSSCOMPILING=True -DCMAKE_TOOLCHAIN_FILE=../../../Scripts/CMake/lemon-cmake-options.txt -DCMAKE_INSTALL_PREFIX=/system -DBUILD_SHARED_LIBS=ON -DLIBRESSL_APPS=OFF -DHAVE_TIMEGM=OFF
