...
[[noreturn]] void kmain(){
	...
	Video::DrawString("Copyright 2004-2022 Felix Montanari", 2, videoMode.height - 100, 255, 255, 255);
	Video::DrawString(Lemon::versionString, 10, videoMode.height - 200, 255, 255, 255);
