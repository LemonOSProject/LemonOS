...
void WMWindow::Draw(surface_t* surface){
	...
	Lemon::Graphics::DrawGradientVertical({pos + (vector2i_t){1,1}, {size.x + WINDOW_BORDER_THICKNESS, WINDOW_TITLEBAR_HEIGHT}}, {0x29, 0x2c, 0x33, 255}, {0x29, 0x29, 0x2e, 255}, surface);
