cp Resources/* Initrd/
cp -L ~/.local/share/lemon/sysroot/system/lib/libc*.so* ~/.local/share/lemon/sysroot/system/lib/libunwind.so* ~/.local/share/lemon/sysroot/system/lib/ld.so* Initrd/ # Only copy crucial libraries
